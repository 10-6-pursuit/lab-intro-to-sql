...
INSERT INTO
  gifts (gift, giver, value, previously_regifted)
  VALUES
  ('warm apple pie candle', 'Josh', 12, FALSE),
  ('keyboard mouse', 'Eduardo', 90, FALSE),
  ('sun glasses', 'Dad', 50, TRUE),
  ('desk leather pad', 'Brandon', 90, FALSE),
  ('running shoes', 'Mom', 80, FALSE);
...
-- 
SELECT COUNT(gift='%candle%') FROM gifts;
