...
INSERT INTO gifts (gift, giver, value, previously_regifted )
VALUES 
  ('black ice candle', 'Bugs Bunny', 12, FALSE),
  ('Knicks Tickets', 'Raz', 10, FALSE),
  ('socks', 'Dad', 2, TRUE),
  ('bracelet', 'Shanel', 350, FALSE),
  ('magic candles', 'Dumbledore', 7, TRUE);
...
-- 
UPDATE gifts SET value = 2999 WHERE id = (SELECT id FROM gifts ORDER BY id LIMIT 1 OFFSET 1);
...
--
SELECT ROUND(AVG(value), 2) FROM gifts;

-- 
 \echo Limit to 3 gifts, offset by 2 and order by value descending
--
