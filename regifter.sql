...
CREATE TABLE gift 
(id SERIAL PRIMARY KEY, gift VARCHAR(100), giver VARCHAR(100), value INT,previously_regifted BOOL);
...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
('rose water', 'girlfriend', '9', TRUE),
('coconut oil', 'betty', '21', TRUE),
('rosewell', 'jay', '29', true),
('gel-pens', 'muji', '2.09', TRUE),
('face wash', 'girlfriend', '25', true)
;
--
