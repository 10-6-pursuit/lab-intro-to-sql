...
('soap on a rope', 'Rudolf', '29', FALSE),
 ('potpurri', 'Elf on the Shelf', '39', TRUE), ('mango candle', 'The Boss', '49', FALSE)
 ;
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES ('peach candle', 'Santa', '9', TRUE),
('sans soda drink', 'Mum', '8', FALSE),
('Vanilla candle', 'self', '1000', FALSE),
('car', 'father', '28000', TRUE),
('house', 'husband', '190000', TRUE);
...
--
FROM gifts ORDER BY value DESC  LIMIT 3 OFFSET 2;
--
-- finish
--
