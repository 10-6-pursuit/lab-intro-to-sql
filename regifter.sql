...
VALUES
    ...
    ('PS5', 'Dad', 550, false),
    ('XBOX', 'Mom', 300, true),
    ('Nintendo Switch', 'Grandma', 120, true),
    ('Leap Frog', 'Grandpa', 75, false);
...
-- 
 \echo Limit to 2 gifts, offset by 4 and order by price ascending
--
SELECT * FROM gifts ORDER BY value ASC LIMIT 2 OFFSET 4;
--
-- finish
--
